...
<?php         while ($donnees =
        $reponse->fetch()
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><form action="delproduit.php" method="post" class="del2">
    ...
    $reponse->closeCursor(); ?>
             ...
             <?php $reponse = $bdd->query('SELECT * FROM users'); ?>
        ...
        $reponse->fetch()
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><form action="delprofil.php" method="post" class="del2">
                            <button class=" btnn0"  type="submit" >
                            <img src="images/icone/trash-svg.svg" width="20" height="20" class="right" title="Supprimer l'article"></button>
                            <input type="hidden" name="id" value="<?php echo $donnees['idUsers'] ?>"/>  
                        </form> </td>
                        </tr>
                        <?php }
    $reponse->closeCursor(); ?>
                    ...
                    <!-- liste des messages -->
                    <?php $reponse = $bdd->query('SELECT * FROM commentaire'); ?>
        ...
        $reponse->fetch()
                        ...
                        <tr>
                          ...
                          <td class="comment-text"><?php echo ($donnees['texte']); ?></td>
                          <td></td>
                          <td></td>
                          <td></td>
                          <td><form action="delcommm.php" method="post" class="del2">
                            <button class=" btnn0"  type="submit" >
                            <img src="images/icone/trash-svg.svg" width="20" height="20" class="right" title="Supprimer l'article"></button>
                            <input type="hidden" name="id" value="<?php echo $donnees['id'] ?>"/>  
                        </form> </td>
