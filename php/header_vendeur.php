            ...
            <div class="col-12">
              <nav class="site-navigation text-right ml-auto " role="navigation">
                ...
                <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                  ...
                  <li><a href="/PPE/addproduct.php" class="nav-link">Ajoute article</a></li>
                  <li><a href="/PPE/vendeur.php" class="nav-link">Vendeur</a></li>

                  
                  <li><a href="/PPE/profil.php" id="button" class="nav-link"><?php echo $_SESSION['pseudo']; ?></a></li>
                  <li><a href="/PPE/déconnexion.php" class="nav-link">Déconnexion</a></li>
                </ul>
              </nav>
